package com.markerhub.vueadminjava;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://db201.dev.rs.com:3306/db_cmall?useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull");
        // dsc.setSchemaName("public");
        dsc.setDriverName("com.mysql.jdbc.Driver");
        dsc.setUsername("fmall");
        dsc.setPassword("fmall_user");
